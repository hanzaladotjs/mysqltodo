...
const TodoViewElement = () => {
    ...
    const [todus, setTodus] = useState<any>([])
        ...
        <div>
           {!showSingle ?<ul>
            ...
            : <div className="flex flex-col space-y-5 items-center">
                <div> <p className="text-2xl font-bold mr-17">Title:</p> <p className="text-lg">{singleTodo.name} </p> </div>
